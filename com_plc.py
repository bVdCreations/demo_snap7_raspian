...
class PLC:
    ...
    def read_input(self, input_name):
        ...
        # read the bytearray
        _bytearray = self._plc.read_area(area['PA'], 0, input_instance.get_byte(), input_instance.get_size())
    ...
    def write_input(self, input_name, value):
        ...
        self._plc.write_area(area['PA'], 0, input_instance.get_byte(), _bytearray)
    ...
    class IO_PLC:
        ...
        def read_bytearray(self, _read_bytearry, offset_on=False):
            ...
            if self._type == "BOOL":
                return util.get_bool(_bytearray_read, offset, self.get_bit_offset())
